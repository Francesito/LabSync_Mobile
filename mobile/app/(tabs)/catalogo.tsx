    ...
    {error && <Text style={styles.alertCustom}>{error}</Text>}
            ...
            <Modal visible={showDetailModal} animationType="fade" transparent={true} onRequestClose={() => setShowDetailModal(false)}>
                ...
                <View style={styles.modalContentCustom}>
                    ...
                    <TouchableOpacity
    style={[styles.btnSecondaryCustom, { width: '100%', marginTop: 8 }]}
...
>
                ...
                <View style={styles.modalContentCustom}>
                    ...
                    {selectedCart.map((item) => (
                        ...
                        <Text style={[styles.fontSemibold, styles.requestItemName]}>
...
searchContainer: {
  ...
  textAlign: 'center',
  fontSize: 14,
  width: '100%',        // ⬅️ antes 80, ahora ocupa todo el ancho
  marginBottom: 12,
},
    btnAddToCart: {
        backgroundColor: '#003579',
